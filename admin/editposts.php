...
<title>Blog-后台管理</title>
	...
	<h2>
						    <p>编辑文章</p>
							<p><?php if(!empty($_GET['edit'])){?>&nbsp;<button type="button" class="btn btn-success" onclick="createnew()">新建文章</button><?php }?></p>
							</h2>
							<?php if(empty($_GET['edit'])){ echo "<p>-新文章</p>";}else{echo "文章id：$editpost";}?>
					  ...
					  <p><input type="text" class="form-control" id="postdate" name="postdate" placeholder="日期（格式：20180324）" value="<?php if(!empty($rdate)){echo $rdate;}else{echo date("Ymd");}?>"></p>
					  <p>&nbsp;</p>
...
<form id="subform" action="compile.php?type=posts&edit=<?php if(empty($_GET['edit'])){echo "new";}else{echo "id".$editpost;}?>" method="post">
...
<script src="./../assets/js/jquery.min.js"></script>
>>>>>>> 6786e98801e306c03b96a4aa506a0bba803c3800
